                                ...
                                <div className="row text-light py-5">
                                    ...
                                    <div className="col-md-12" style={{ minHeight: '40vh' }}>
                                        <div className="row d-flex justify-content-center">
                                            ...
                                            <div className="col p-0 m-2 d-flex shadow flex-column justify-content-between alert alert-success">
                                            ...
                                            <div className="col p-0 m-2 d-flex shadow flex-column justify-content-between alert alert-danger">
                                                <div className="row m-2 my-4">
                                                    <div className="col-1">
                                                        <div className="total fw-bold fs-4">
                                                            {iborrow}
                                            ...
                                            <div className="col p-0 m-2 d-flex shadow flex-column justify-content-between alert alert-primary">
                                                <div className="row m-2 my-4">
                                                    <div className="col-1">
                                                        <div className="total fw-bold fs-4">
                                                            {totaluser}
                                            ...
                                            <div className="col p-0 m-2 d-flex shadow flex-column justify-content-between alert alert-warning">
                                                <div className="row m-2 my-4">
                                                    <div className="col-1">
                                                        <div className="total fw-bold fs-4">
                                                            {totall}
                                    ...
                                    <div className="col-12" style={{ marginBottom: '20vh' }}>
